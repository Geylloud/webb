...
$teams = require '../processing/showteamspr.php';
?>
        ...
        <?php if (!empty($teams)): ?>
            <div class="team-list">
                <?php foreach ($teams as $team): ?>
                    <div class="team-card" onclick="window.location.href='teamdetails.php?team_id=<?php echo $team['id']; ?>'">
                        <h3><?php echo htmlspecialchars($team['name']); ?></h3>
                        <p>Role: <?php echo ucfirst(htmlspecialchars($team['role'])); ?></p>
                    </div>
                <?php endforeach; ?>
            </div>
        <?php else: ?>
            <p>No teams found. <a href="Create_team.php" style="color: var(--accent-color);">Create a team now!</a></p>
        <?php endif; ?>
    </div>
